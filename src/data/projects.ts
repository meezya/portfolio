		...
		projects: [
			...
			},
			{
				...
				body: [
					...
					`Authentic cultural integration. Integrate design, fashion (Acne Studios, Kith, Stone Island), female innovators in music, and targeted content built around how the product aligns with the lifestyle goals of our market.`,
					`Make the premium make sense. A "Hear the Difference" campaign built on blind listening tests, technical demonstrations, and pro audio endorsements. Reframe price as investment in quality of life.`,
					`Optimize distribution. Expand the Experience Room concept beyond Best Buy, build a certified installer network for high-end setups, and lean into DTC where margins and customer relationships are stronger.`,
				],
				link: { label: 'Read Full Brand Audit Here', href: '/papers/sonos-audit.pdf' },
				tiles: [
					{
						type: 'image',
						src: '/projects/sonos-audit/deck-cover.png',
						width: 272,
						height: 300,
						frame: { width: 533, height: 300, left: 0, top: 0 },
					},
					{
						type: 'image',
						src: '/projects/sonos-audit/deck-awareness.png',
						width: 272,
						height: 300,
						frame: { width: 533, height: 300, left: 0, top: 0 },
					},
					{
						...
						preview: '/projects/sonos-audit/deck-close.png',
						width: 272,
						height: 300,
						opacity: 0.4,
						title: 'View the audit deck (18 slides)',
						caption: 'Pdf · Read',
						frame: { width: 533, height: 300, left: -131, top: 0 },
					},
				],
			},
			{
				slug: 'nothing-research',
				name: 'Nothing: Bridging Niche Appeal and Mainstream Adoption',
				headingFont: 'STSong',
				headingWeight: 300,
				body: [
					...
					'Findings and recommendations packaged as a 16-slide research deck. WVU Reed College of Media. April 2025.',
				],
				tiles: [
					{
						type: 'image',
						src: '/projects/nothing-research/cover.png',
						width: 272,
						height: 300,
						frame: { width: 622, height: 350, left: -30, top: -25 },
					},
					{
						type: 'image',
						src: '/projects/nothing-research/awareness.png',
						width: 272,
						height: 300,
						frame: { width: 533, height: 300, left: 0, top: 0 },
					},
					{
						...
						preview: '/projects/nothing-research/thesis.png',
						width: 272,
						height: 300,
						opacity: 0.4,
			...
			},
			{
				...
				tiles: [
					{
						type: 'image',
						src: '/projects/healthcare-bystanders/deck-cover.png',
						width: 272,
						height: 300,
						frame: { width: 533, height: 300, left: 0, top: 0 },
					},
					{
						type: 'image',
						src: '/projects/healthcare-bystanders/deck-situation.png',
						width: 272,
						height: 300,
						frame: { width: 533, height: 300, left: 0, top: 0 },
					},
					{
						...
						preview: '/projects/healthcare-bystanders/deck-insight.png',
						width: 272,
						height: 300,
						opacity: 0.4,
